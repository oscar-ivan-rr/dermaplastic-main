...
// Se valida si está activa la opción de filtrar por padecimiento con la variable $_SESSION['use_condition']
if ( GETPOST('filtre', 'alpha') ) {
	// Avec filtre
	$ret=array(); $i=0;

	$sql = "SELECT p.rowid, p.ref, p.label, p.tva_tx, p.fk_product_type, lcp.fk_categorie";
	...
	$sql.= " AND lcp.fk_categorie = '".$db->escape(GETPOST('filtre'))."'";
	if ($_SESSION['use_condition'] == 1)
	{
