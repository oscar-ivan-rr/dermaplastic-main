...
<div class="conteneur_img_droite2">
...
<fieldset class="cadre_facturation2"><legend class="titre1"><?php echo $langs->trans("Identification"); ?></legend>
...
<table>
	...
	<tr>
		<td class="label1 texte3"><?php echo $langs->trans("Login"); ?></td>
		<td><input name="txtUsername" class="texte_login texte3 maxwidth150onsmartphoneimp" type="text" value="<?php echo $usertxt; ?>" /></td>
	</tr>
	<tr>
		<td class="label1 texte3"><?php echo $langs->trans("Password"); ?></td>
		<td><input name="pwdPassword" class="texte_login texte3 maxwidth150onsmartphoneimp" type="password" value="" /></td>
	</tr>
...
<?php
print "<tr>";
print '<td class="label1 texte3">'.$langs->trans("CashDeskThirdPartyForSell").'</td>';
print '<td class="texte3">';
$disabled=0;
...
if (! empty($conf->stock->enabled) && empty($conf->global->CASHDESK_NO_DECREASE_STOCK))
{
	$langs->load("stocks");
	print "<tr>";
	print '<td class="label1 texte3">'.$langs->trans("Warehouse").'</td>';
	print '<td>';
	$disabled=0;
...
print "<tr>";
print '<td class="label1 texte3">'.$langs->trans("CashDeskBankAccountForSell").'</td>';
print '<td class="texte3">';
$defaultknown=0;
...
print "<tr>";
print '<td class="label1 texte3">'.$langs->trans("CashDeskBankAccountForCheque").'</td>';
print '<td class="texte3">';
$defaultknown=0;
...
print "<tr>";
print '<td class="label1 texte3">'.$langs->trans("CashDeskBankAccountForCB").'</td>';
print '<td class="texte3">';
$defaultknown=0;
...
<div align="center"><input style="border-radius: 27px; background: #013BAC; color:#fff;" class="button btnlogin" name="sbmtConnexion" type="submit" value="<?php echo dol_escape_htmltag($langs->trans("Connection")); ?>" /></div>
