...
class Facturation
{
    ...
    public function ajoutArticle()
    {
        ...
        //Campo usado para agregar indicaciones de receta
        $newcartarray[$i]['note'] = $this->note();
    ...
    //Agregar indicaciones del producto para la receta
    public function addNoteArticle($aArticle, $note)
    {
        $poscart=$_SESSION['poscart'];
     ...
     * Get Note
     *
     * @param	string		$aNote		Note
     * @return	string					Note
     */
    public function note($aNote = null)
    {
        if (is_null($aNote))
        {
            return $this->note;
