<?php
	...
	//============================================================+
	// File name   : pdfprevio_factura.php
	// Begin       : 2022-02-11
	// Last Update : 2022-02-11
	//
	// Description : Generador de PDF Previo del módulo CFDI
	//
	//
	...
	class cfdiPDF extends tFPDF
	{
		...
		var $color_div_emisor;
		var $color_div_receptor;
		var $color_div_comprobante;
		var $color_div_datosfiscales_titulo;
		var $color_div_datosfiscales_sellos;
		var $color_div_conceptos;
		var $color_div_cartaporte;
		var $color_div_cce;
		var $color_div_notas;
		var $color_div_cfdi_relacionados;
		var $color_div_totales;
		var $color_titulos;
		var $color_valores;
		...
		function color(){
			##Inicia Asignacion de Colores
			$this->color_div_totales = array(
										"color1" => 194, "color2" => 229, "color3" => 243
									);

			$this->color_div_datosfiscales_titulo = array(
										"color1" => 16, "color2" => 120, "color3" => 179
									);

			$this->color_titulos = array(
										"color1" => 0, "color2" => 15, "color3" => 255
									);

			$this->color_valores = array(
										"color1" => 0, "color2" => 0, "color3" => 0
									);

			$this->color_div_emisor = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255,
										"color7" => 0, "color8" => 15, "color9" => 255 //Color de Letras 
									);

			$this->color_div_comprobante = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255
									);

			$this->color_div_notas = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255
									);

			$this->color_div_receptor = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255
									);

			$this->color_div_cfdi_relacionados = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255
									);

			$this->color_div_conceptos = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255,
										"color7" => 215, "color8" => 0, "color9" => 0,
										"color10" => 255, "color11" => 255, "color12" => 255
									);

			$this->color_div_datosfiscales_sellos = array(
										"color1" => 16, "color2" => 120, "color3" => 179,
										"color4" => 255, "color5" => 255, "color6" => 255
									);
			
			##Termina Asignacion de Colores
		}
		...
		function SetData($id) {
			...
			$datos["uuid"] = 'XXXXX-XXXXXX-XXXXXXX-XXXXXX';
			$datos["moneda"] = 'XXX';
			$datos["cadena"] = '$obj->cadena';
			$datos["selloCFD"] = '0000000000000000000';
			$datos["selloSAT"] = '0000000000000000000';
			$datos["fechaTimbrado"] = 'yyyy-mm-ddT00:00:00';
			$datos["certificado"] = '0000000000000000000';
			$datos["certEmisor"] = '0000000000000000000';
			$datos["u4dig"] = '0000000000000000000';
			$datos["fechaEmision"] = 'yyyy-mm-ddT00:00:00';
...
//Informacion Emisor
		    ...
		    if($factura->type == 2){
				$tipoComprobante = "E";
				$labeltipoComprobante = "E - Egreso";
			}else{
				$tipoComprobante = "I";
				$labeltipoComprobante = "I - Ingreso";

				$sql     = "SELECT * FROM " . MAIN_DB_PREFIX . "cfdimx_type_document WHERE fk_facture=" . $id;
		        ...
		        if($res_sql){
		        	...
		        	if($obj_tipoComprobante->tipo_document == 7){
		        		$tipoComprobante = "T";
		        		$labeltipoComprobante = "T - Traslado";
		        	}
		        }
			}
			// $this->data["moneda"] = $factura->multicurrency_code;
			$datos["moneda"]      = $factura->multicurrency_code;
            ...
            $clave_exportacion = $factura->array_options["options_clave_expor"];
		    ...
		    $datos_comprobante = array(
						...
						"labeltipoComprobante" => $labeltipoComprobante,
						...
						"version_cfdi" => $conf->global->CFDIMX_VERSION_SAT
					);
        	...
        	if(strcmp($conf->global->CFDIMX_VERSION_SAT, "3.3") == 0){
				...
				if($cliente->town != ''){
					$direccion_receptor_pdf2  .= ($direccion_receptor_pdf2 != '' ? ", ".$cliente->state : $cliente->town);
				}
				...
				$regimen_receptor        = $this->_obtener_catalogo($objdomicilioRepcetor["regimenfiscal"], 4006);
        	}
			...
			// print '<pre>'; print_r($informacion_receptor); print '</pre>'; die;
		}
		...
		// 	if($y_tmp > 255){
		// 		$this->AddPage();
		// 		$this->SetFont($this->tipo_letra,'', 8);
		// 		$this->Ln(5);
		// 		//Dibujar recuadro
		// 		$this->SetDrawColor($this->color_div_cfdi_relacionados["color1"],$this->color_div_cfdi_relacionados["color2"],$this->color_div_cfdi_relacionados["color3"]);
		// 		$this->SetFillColor($this->color_div_cfdi_relacionados["color1"],$this->color_div_cfdi_relacionados["color2"],$this->color_div_cfdi_relacionados["color3"]);
		// 		$this->RoundedRect($this->GetX(),$this->GetY()+1,190,5,3,'DF','1234');

		// 		//Cabeceras de tabla de partidas
		// 		$this->SetTextColor($this->color_div_cfdi_relacionados["color4"],$this->color_div_cfdi_relacionados["color5"],$this->color_div_cfdi_relacionados["color6"]);
		...
		// 		$this->Ln();
		// 		$this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
		// 	}

		// 	$this->SetFont($this->tipo_letra,'', 7);
		...
		// 		$this->Rect($x,$y,$w,$h);
		// 		//Print the text
		// 		$this->MultiCell($w,4,$data[$i],0,$a, false);#el valor de 5 es el interlineado entre renglones del texto
		...
		function Header() {
            ...
            $this->SetX(139);
            $this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
            ...
            $this->Cell(60,4, $this->data["fechaEmision"],"",1,'C');// LRB
   			...
   			$this->SetDrawColor($this->color_div_datosfiscales_titulo["color1"],$this->color_div_datosfiscales_titulo["color2"],$this->color_div_datosfiscales_titulo["color3"]);
			$this->SetFillColor($this->color_div_datosfiscales_titulo["color1"],$this->color_div_datosfiscales_titulo["color2"],$this->color_div_datosfiscales_titulo["color3"]);

			$this->RoundedRect(138,$this->GetY()-45,62,45, 5,'D'); //$x,$y,$w,$h

            //Inicia Informacion Emisor
            //Dibujar recuadro
			$this->SetDrawColor($this->color_div_emisor["color1"],$this->color_div_emisor["color2"],$this->color_div_emisor["color3"]);
			$this->SetFillColor($this->color_div_emisor["color1"],$this->color_div_emisor["color2"],$this->color_div_emisor["color3"]);
			$this->RoundedRect(10,25,125,5,3,'DF','1234');
			
			$this->SetTextColor($this->color_div_emisor["color4"],$this->color_div_emisor["color5"],$this->color_div_emisor["color6"]);
			$this->Ln();
			$this->SetFont($this->tipo_letra,'',9);
			$this->SetXY(10, 26);
			...
			$this->SetFont($this->tipo_letra,'',8);
			$this->SetXY(10, 31);
			$this->SetTextColor($this->color_div_emisor["color7"],$this->color_div_emisor["color8"],$this->color_div_emisor["color9"]);
			$this->Cell(80,4,$this->emisor["nombre"],0,0,'L');
			...
			$this->SetXY(10, 39);
			$this->Cell(80,4,$this->emisor["emisorRegimenEtiqueta"],0,0,'L');

			$this->SetFont($this->tipo_letra,'',8);
			$this->SetXY(10, 43);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
			$this->Cell(80,4,$this->emisor["direccion_pdf"],0,0,'L');

			$this->SetXY(10, 47);
			$this->Cell(80,4,$this->emisor["direccion_pdf2"],0,0,'L');
		...
		function _pageCFDIRel($x, $y){
			...
			if($this->datoscomprobante["tipoRelacion"] != '' || $this->datoscomprobante["tipoRelacion"] != null){
				...
				if($valida_cfdi_rel > 0){ 
					...
					$this->Cell(75,4,"    CFDIS Relacionados - ".$this->datoscomprobante["tipoRelacion"],0,0,'L');
					$this->Ln();
	    ...
	    function _pageDatosComprobante($x, $y) {
	    	//Dibujar recuadro
			$this->SetDrawColor($this->color_div_comprobante["color1"],$this->color_div_comprobante["color2"],$this->color_div_comprobante["color3"]);
			$this->SetFillColor($this->color_div_comprobante["color1"],$this->color_div_comprobante["color2"],$this->color_div_comprobante["color3"]);
			$this->RoundedRect($this->GetX(),$this->GetY()+1,190,5,3,'DF','1234');
			$this->SetTextColor($this->color_div_comprobante["color4"],$this->color_div_comprobante["color5"],$this->color_div_comprobante["color6"]);
			...
			$this->SetXY($x+26, $y+7);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
			$this->Cell(75,4,$this->datoscomprobante["labeltipoComprobante"],0,0,'L');
			...
			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+65, $y+15);
			$this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
			$this->Cell(75,4,$label_etiqueta1,0,0,'L');
			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+72, $y+15);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
			...
			$this->SetXY($x+60, $y+7);
			$this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
			$this->Cell(75,4,"Método de Pago:",0,0,'L');
			$this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+83, $y+7);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
			$this->Cell(75,4,$this->datoscomprobante["metodoDePago"],0,0,'L');

			$this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+90, $y+15);
			$this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
			$this->Cell(75,4,$label_etiqueta2,0,0,'L');
			$this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+106, $y+15);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
	    ...
	    // Función para mostrar el cuadro de datos del receptor
	   	function _pageReceptor($x, $y) {
		    //Dibujar recuadro
			$this->SetDrawColor($this->color_div_receptor["color1"],$this->color_div_receptor["color2"],$this->color_div_receptor["color3"]);
			$this->SetFillColor($this->color_div_receptor["color1"],$this->color_div_receptor["color2"],$this->color_div_receptor["color3"]);
			$this->RoundedRect($this->GetX(),$this->GetY()+1,190,5,3,'DF','1234');
			$this->SetTextColor($this->color_div_receptor["color4"],$this->color_div_receptor["color5"],$this->color_div_receptor["color6"]);
			...
			$this->SetXY($x, $y+7);
			$this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
			$this->Cell(80,4,$this->receptor["nombre"],0,0,'L');
			...
			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+50, $y+11);
			$this->SetTextColor($this->color_titulos["color1"],$this->color_titulos["color2"],$this->color_titulos["color3"]);
			$this->Cell(75,4,"Uso CFDI: ",0,0,'L');
			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x+63, $y+11);
			$this->SetTextColor($this->color_valores["color1"],$this->color_valores["color2"],$this->color_valores["color3"]);
			$this->Cell(75,4,$this->datoscomprobante["usoCFDI"],0,0,'L');

			// $this->SetFont($this->tipo_letra,'',8);

			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x, $y+15);
			$this->Cell(80,4,$this->receptor["regimenfiscal"],0,'L');			

			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x, $y+19);
			$this->Cell(80,4,$this->receptor["direccion_pdf"],0,0,'L');

			// $this->SetFont($this->tipo_letra,'',8);
			$this->SetXY($x, $y+23);
			$this->Cell(80,4,$this->receptor["direccion_pdf2"],0,0,'L');

			$this->SetXY($x+60, $y+23);
			$this->Cell(75,4,$this->receptor["ref_client"],0,0,'L');
		...
		function _pageObservaciones($x, $y) {
			...
			//Dibujar recuadro
			$this->SetDrawColor($this->color_div_notas["color1"],$this->color_div_notas["color2"],$this->color_div_notas["color3"]);
			$this->SetFillColor($this->color_div_notas["color1"],$this->color_div_notas["color2"],$this->color_div_notas["color3"]);
			$this->RoundedRect($this->GetX(),$this->GetY()+1,190,5,3,'DF','1234');
			$this->SetTextColor($this->color_div_notas["color4"],$this->color_div_notas["color5"],$this->color_div_notas["color6"]);
			...
			$this->SetDrawColor($this->color_div_notas["color1"],$this->color_div_notas["color2"],$this->color_div_notas["color3"]);
			$this->SetFillColor($this->color_div_notas["color1"],$this->color_div_notas["color2"],$this->color_div_notas["color3"]);
			$this->RoundedRect($this->GetX(),$this->GetY()-$tam_cuadro+2,190,$tam_cuadro - 4,2,'D','1234');
		...
		function _pageConceptos(){
		    ...
		    $this->datoscomprobante['moneda'] = "EUR";

		    $this->SetDrawColor($this->color_div_conceptos["color1"],$this->color_div_conceptos["color2"],$this->color_div_conceptos["color3"]);
			$this->SetFillColor($this->color_div_conceptos["color1"],$this->color_div_conceptos["color2"],$this->color_div_conceptos["color3"]);
			$this->RoundedRect($this->GetX(),$this->GetY()+1,190,5,3,'DF','1234');

			//Cabeceras de tabla de partidas
			$this->SetFont($this->tipo_letra,'',9);
			$this->SetTextColor($this->color_div_conceptos["color4"],$this->color_div_conceptos["color5"],$this->color_div_conceptos["color6"]);
			$this->Cell(180,7,"    Conceptos",0,0,'L');
			$this->Ln();
			$this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
			$this->SetFont($this->tipo_letra,'',8);
			...
			for($i=0;$i<sizeof($object->lines);$i++) {
				...
				if ($object->lines[$i]->fk_product != "") {
					...
					if($conf->global->CFDIMX_DESC_PROD_NO_CAT_DESC == 1){
						if($object->lines[$i]->desc != ""){
							$lista_descripciones[] = $object->lines[$i]->desc;
						}
					}
					...
					if($object->lines[$i]->array_options["options_umed"] != ""){
						$unidad = $object->lines[$i]->array_options["options_umed"];
					}

					if($object->lines[$i]->array_options["options_claveprodserv"] != ""){
						$claveprodserv = $object->lines[$i]->array_options["options_claveprodserv"];
					}

					if($object->lines[$i]->array_options["options_exentoiva"] != ""){
						$tipoFactor = $object->lines[$i]->array_options["options_exentoiva"];
					}

					if($object->lines[$i]->array_options["options_objimp"] != ""){
						$objimp = $object->lines[$i]->array_options["options_objimp"];
					}

					//Termina Ajuste para tomar lo que se capture fuera del catalogo
				}else{
					$descripcion      = $object->lines[$i]->desc;
					$unidad           = $object->lines[$i]->array_options["options_umed"];
					$claveprodserv    = $object->lines[$i]->array_options["options_claveprodserv"];
				...
				if($conf->global->CFDIMX_DESC_PDF == 0){
					...
					$descripcion_pdf = mb_strtoupper($descripcion);
				}

				$impuesto = "002";
				$tasa = number_format(($object->lines[$i]->tva_tx/100),6);

				$num_espacios = 1;
				if(strlen($descripcion_pdf) <= 130){
					$num_espacios = 2;
				}else{
					if(strlen($descripcion_pdf) <= 270){
						$num_espacios = 3;
					}else{
						if(strlen($descripcion_pdf) <= 410){
							$num_espacios = 4;
						}else{
							if(strlen($descripcion_pdf) <= 570){
								$num_espacios = 5;
							}else{
								if(strlen($descripcion_pdf) <= 690){
									$num_espacios = 6;
								}else{
									if(strlen($descripcion_pdf) <= 830){
										$num_espacios = 7;
									}else{
										if(strlen($descripcion_pdf) <= 970){
											$num_espacios = 8;
										}else{
											if(strlen($descripcion_pdf) <= 999){
												$num_espacios = 9;
											}else{
												if(strlen($descripcion_pdf) >= 1000){
													$num_espacios = 9;
												}
											}
										}	
			    ...
			    $this->SetXY($x2, $y2+4);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				// $this->Cell(80,4,utf8_decode($this->limpiar($obj_mercancia->descripcion)),0,0,'L');
				// $this->MultiCell(190,4,utf8_decode($this->limpiar($obj_mercancia->descripcion)),0, "L", false);
				$this->MultiCell(190,4,trim($descripcion_pdf),0, "L", false);

				#Fila 2
				$fila2x = $x2 + 20;
				$this->SetXY($x2, $y2+$fila2);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Clave: ",0,0,'L');
			    $this->SetXY($x2+8, $y2+$fila2);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,$claveprodserv,0,0,'L');

				$this->SetXY($x2+$fila2x, $y2+$fila2);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Unidad: ",0,0,'L');
			    $this->SetXY($x2+$fila2x+10, $y2+$fila2);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,$unidad,0,0,'L');

			    $this->SetXY($x2+$fila2x+30, $y2+$fila2);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Cantidad: ",0,0,'L');
			    $this->SetXY($x2+$fila2x+44, $y2+$fila2);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,$cantidad,0,0,'L');

				$this->SetXY($x2+$fila2x+55, $y2+$fila2);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Precio Unitario: ",0,0,'L');
			    $this->SetXY($x2+$fila2x+76, $y2+$fila2);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,price($precio_unitario, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'L');

				#Fila 3
				// $fila2x = $x2 + 20;
				// $this->SetDrawColor($this->color_div_conceptos["color7"],$this->color_div_conceptos["color8"],$this->color_div_conceptos["color9"]);
				// $this->SetFillColor($this->color_div_conceptos["color7"],$this->color_div_conceptos["color8"],$this->color_div_conceptos["color9"]);
				// $this->RoundedRect($x2, $y2+$fila3,150,5,3,'DF',' ');
				// $this->SetFont($this->tipo_letra,'',9);
				// $this->SetTextColor($this->color_div_conceptos["color10"],$this->color_div_conceptos["color11"],$this->color_div_conceptos["color12"]);
				// $this->SetXY($x2, $y2+$fila3-1);
				// $this->Cell(180,7,"    Impuestos Trasladados",0,0,'L');
				// $this->Ln();
				// $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				// $this->SetFont($this->tipo_letra,'',8);

				#Fila 4				
				$this->SetXY($x2, $y2+$fila3);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Impuesto: ",0,0,'L');
			    $this->SetXY($x2+13, $y2+$fila3);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,$impuesto,0,0,'L');

				$this->SetXY($x2+25, $y2+$fila3);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Tasa: ",0,0,'L');
			    $this->SetXY($x2+32, $y2+$fila3);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,$tasa,0,0,'L');

				$this->SetXY($x2+50, $y2+$fila3);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"I.V.A.: ",0,0,'L');
			    $this->SetXY($x2+58, $y2+$fila3);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,price($iva, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'L');

				$this->SetXY($x2+81, $y2+$fila3);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Descuento: ",0,0,'L');
			    $this->SetXY($x2+96, $y2+$fila3);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,price($total_des, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'L');

				$this->SetXY($x2+120, $y2+$fila3);
			    $this->SetTextColor($this->color_titulos["color1"], $this->color_titulos["color2"], $this->color_titulos["color3"]);
				$this->Cell(80,4,"Importe: ",0,0,'L');
			    $this->SetXY($x2+131, $y2+$fila3);
			    $this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
				$this->Cell(80,4,price($total_partida, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'L');
		...
		function _pageCartaPorte(){
			...
			if($num_head_cartaporte > 0){
				...
				$this->SetFont($this->tipo_letra,'',8);
				$this->SetXY($x+30, $y+5);
				$this->Cell(80,4,utf8_decode($this->limpiar($label_transporte)),0,0,'L');
				...
				$this->SetFont($this->tipo_letra,'',8);
				$this->SetXY($x+85, $y+1);
				$this->Cell(80,4,utf8_decode($this->limpiar($label_transporte_int)),0,0,'L');
				...
				$this->Cell(80,4,utf8_decode($this->limpiar("Pa&iacute;s Origen/Destino: ")),0,0,'L');
				$this->SetFont($this->tipo_letra,'',8);
				...
				if($num_ubicaciones > 0){
					...
					while ($obj_ubicacion = $db->fetch_object($res_ubicaciones)) {
						...
						$this->SetXY($x+40, $y+1);
						$this->Cell(80,4,utf8_decode("Tipo Estación: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
						$this->SetXY($x+60, $y+1);
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($obj_ubicacion->id_ubicacion)),0,0,'L');

						//Fila 2
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x, $y+5);
						$this->Cell(80,4,utf8_decode("Tipo Ubicación: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x+22, $y+5);
						...
						$this->SetFont($this->tipo_letra,'',8);
						$this->SetXY($x+40, $y+5);
						$this->Cell(80,4,utf8_decode("Navegación Trafico: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
						$this->SetXY($x+68, $y+5);
						...
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x, $y+9);
						$this->Cell(80,4,utf8_decode("Num. Estación: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x+21, $y+9);
						...
						$this->SetFont($this->tipo_letra,'',8);
						$this->SetXY($x+40, $y+9);
						$this->Cell(80,4,utf8_decode("Nombre Estación: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
						$this->SetXY($x+65, $y+9);
						$this->Cell(80,4,utf8_decode($this->limpiar($obj_ubicacion->nom_estacion)),0,0,'L');
						...
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x+8, $y+21);
						$this->Cell(80,4,utf8_decode($this->limpiar($obj_ubicacion->calle)),0,0,'L');
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($obj_ubicacion->num_int)),0,0,'L');
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($obj_ubicacion->num_ext)),0,0,'L');
						...
						$this->Cell(80,4,utf8_decode("País: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
				...
				if($num_head_mercancia > 0){
					...
					$this->Cell(80,4,utf8_decode("Número Total Mercancia: "),0,0,'L');
					$this->SetFont($this->tipo_letra,'',8);
				...
				if($num_mercancias > 0){
					...
					while($obj_mercancia = $db->fetch_object($res_mercancias)){
						$num_espacios = 1;
						if(strlen($obj_mercancia->descripcion) <= 140){
							$num_espacios = 3;
						}else{
							if(strlen($obj_mercancia->descripcion) <= 280){
								$num_espacios = 4;
							}else{
								if(strlen($obj_mercancia->descripcion) <= 420){
									$num_espacios = 5;
								}else{
									if(strlen($obj_mercancia->descripcion) <= 560){
										$num_espacios = 6;
									}else{
										if(strlen($obj_mercancia->descripcion) <= 700){
											$num_espacios = 7;
										}else{
											if(strlen($obj_mercancia->descripcion) <= 840){
												$num_espacios = 8;
											}else{
												if(strlen($obj_mercancia->descripcion) <= 980){
													$num_espacios = 9;
												}else{
													if(strlen($obj_mercancia->descripcion) >= 1000){
														$num_espacios = 10;
													}
												}	
											}
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($producto->ref)),0,0,'L');

						//Fila 2
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x2, $y2+5);
						$this->Cell(80,4,utf8_decode("Descripción: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
					    $this->SetXY($x2, $y2+9);
						// $this->Cell(80,4,utf8_decode($this->limpiar($obj_mercancia->descripcion)),0,0,'L');
						$this->MultiCell(190,4,utf8_decode($this->limpiar($obj_mercancia->descripcion)),0, "L", false);
				...
				if($num_mercancia_transporta > 0){
					...
					while($obj_mercancia_transporta = $db->fetch_object($res_mercancia_transporta)){
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($label_mert_cvestransporte)),0,0,'L');
				...
				if($num_detalle_mercancia > 0){
					...
					while($obj_detalle_mercancia = $db->fetch_object($res_detalle_mercancia)){
						...
						$this->Cell(80,4,utf8_decode($this->limpiar($label_unidad_peso)),0,0,'L');
						...
						$this->Cell(80,4,utf8_decode("Número de Piezas: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
				...
				if($num_guias_identificacion > 0){
					...
					if($y_tmp > 265){
						...
						$this->Cell(75,4,utf8_decode("    Guías de Identifiación"),0,0,'L');
						$this->SetTextColor(0,0,0);
					...
					while($obj_guia_identificacion = $db->fetch_object($res_guias_identificacion)){
						...
						$this->Cell(80,4,utf8_decode("Número: "),0,0,'L');
						$this->SetFont($this->tipo_letra,'',8);
				...
				switch($val_tipo_transporte){
					case 1:
							...
							if($num_head_autotransporte > 0){
								...
								$this->SetFont($this->tipo_letra,'',$tamanio_letra);
							    $this->SetXY($x5+19, $y5+1);
								$this->Cell(80,4,utf8_decode($this->limpiar($label_at_permiso_sct)),0,0,'L');

								//Fila 2
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5, $y5+5);
								$this->Cell(80,4,utf8_decode("Número de Permiso SCT: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								if($num_config_vehicular > 0){
									...
									$this->SetFont($this->tipo_letra,'',9);
									$this->SetXY($x6, $y6+1);
									$this->Cell(75,4,utf8_decode("    AutoTransporte - Identificación Vehicular"),0,0,'L');
									$this->SetTextColor(0,0,0);
									...
									while($obj_config_vehicular = $db->fetch_object($res_config_vehicular)){
										...
										if($y_tmp > 265){
											...
											$this->SetFont($this->tipo_letra,'',9);
											$this->SetXY($x6, $y6+1);
											$this->Cell(75,4,utf8_decode("    AutoTransporte - Configuración Vehicular"),0,0,'L');
											$this->SetTextColor(0,0,0);
										...
										$this->SetFont($this->tipo_letra,'',8);
									    $this->SetXY($x6, $y6+1);
										$this->Cell(80,4,utf8_decode("Configuración: "),0,0,'L');
										$this->SetFont($this->tipo_letra,'',$tamanio_letra);
									    $this->SetXY($x6+21, $y6+1);
									    
										$this->Cell(80,4,utf8_decode($this->limpiar($label_configuracion)),0,0,'L');
										...
										$this->Cell(80,4,utf8_decode("Año Modelo VM: "),0,0,'L');
										$this->SetFont($this->tipo_letra,'',8);
								...
								if($num_seguros > 0){
									...
									while($obj_seguro = $db->fetch_object($res_seguros)){
										...
										$this->Cell(80,4,utf8_decode("Póliza Resp. Civil: "),0,0,'L');
										$this->SetFont($this->tipo_letra,'',8);
										...
										$this->Cell(80,4,utf8_decode("Póliza Med. Ambiente: "),0,0,'L');
										$this->SetFont($this->tipo_letra,'',8);
										...
										$this->Cell(80,4,utf8_decode("Póliza Carga: "),0,0,'L');
										$this->SetFont($this->tipo_letra,'',8);
								...
								if($num_at_remolques > 0){
									...
									while($obj_at_remolque = $db->fetch_object($res_at_remolques)){	
										...
										$this->Cell(80,4,utf8_decode($this->limpiar($label_subtipo)),0,0,'L');
					...
					case 2:
							...
							if($num_head_transporte_maritimo > 0){
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Marítimo"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5+19, $y5+1);
								$this->Cell(80,4,utf8_decode($this->limpiar($label_tm_permiso_sct)),0,0,'L');

								//Fila 2
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+5);
								$this->Cell(80,4,utf8_decode("Num. de Permiso SCT: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->Cell(80,4,utf8_decode($this->limpiar($tm_nom_aseg)),0,0,'L');

								//Fila 3
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+9);
								$this->Cell(80,4,utf8_decode("Num. de Póliza de Seguro: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->Cell(80,4,utf8_decode("Tipo de Embarcación: "),0,0,'L');
								$label_tm_tipo_embarcacion = $this->_obtener_catalogo($tm_tipo_embarcacion,16);
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5+$segunda_columna+31, $y5+9);
								$this->Cell(80,4,utf8_decode($this->limpiar($label_tm_tipo_embarcacion)),0,0,'L');
								...
								$this->Cell(80,4,utf8_decode("Número Omi: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->Cell(80,4,utf8_decode("Año Embarcación: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+17);
								$this->Cell(80,4,utf8_decode("Nombre Embarcación: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5+31, $y5+17);
								$this->Cell(80,4,utf8_decode($this->limpiar($tm_nombre_embarcacion)),0,0,'L');

								//Fila 6
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+21);
								$this->Cell(80,4,utf8_decode("Nac. Embarcación: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->Cell(80,4,utf8_decode("Unidades De Arq Bruto: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+29);
								$this->Cell(80,4,utf8_decode("Linea Naviera: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+37);
								$this->Cell(80,4,utf8_decode("Num. Autorización Naviero: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+41);
								$this->Cell(80,4,utf8_decode("Num Conoc Embarc: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x6, $y6+1);
								$this->Cell(75,4,utf8_decode("    Transporte Marítimo - Contenedores"),0,0,'L');
								$this->SetTextColor(0,0,0);
					...
					case 3:
							...
							if($num_head_transporte_aereo > 0){
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Aéreo"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->Cell(80,4,utf8_decode($this->limpiar($label_ta_permiso_sct)),0,0,'L');
								...
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5+35, $y5+5);
								$this->Cell(80,4,utf8_decode($this->limpiar($ta_num_permiso_sct)),0,0,'L');
								...
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5, $y5+13);
								$this->Cell(80,4,utf8_decode("Código Transportista: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Aéreo - Aseguradora"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->Cell(80,4,utf8_decode($this->limpiar($ta_nom_aseg)),0,0,'L');

								//Fila 2
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+5);
								$this->Cell(80,4,utf8_decode("Número de Poliza: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5, $y5+9);
								$this->Cell(80,4,utf8_decode("Número de Guía: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Aéreo - Embarcador"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->Cell(80,4,utf8_decode($this->limpiar($ta_nom_embarcador)),0,0,'L');
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5, $y5+13);
								$this->Cell(80,4,utf8_decode("NumRegIdTrib: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5+22, $y5+13);
					...
					case 4:
							...
							if($num_head_transporte_ferroviario > 0){
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Ferroviario"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->Cell(80,4,utf8_decode($this->limpiar($tf_nom_aseguradora)),0,0,'L');
								...
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5, $y5+9);
								$this->Cell(80,4,utf8_decode("Número Póliza Seguro: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5, $y5+13);
								$this->Cell(80,4,utf8_decode("Tipo de Tráfico: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
							    $this->SetXY($x5+22, $y5+13);
								...
								$this->SetFont($this->tipo_letra,'',9);
								$this->SetXY($x5, $y5+1);
								$this->Cell(75,4,utf8_decode("    Transporte Ferroviario - Carro"),0,0,'L');
								$this->SetTextColor(0,0,0);
								...
								$this->SetFont($this->tipo_letra,'',8);
								$this->SetXY($x5+$segunda_columna, $y5+5);
								$this->Cell(80,4,utf8_decode("Guía: "),0,0,'L');
								$this->SetFont($this->tipo_letra,'',8);
								...
								if($num_tf_contenedores > 0){
									...
									$this->SetFont($this->tipo_letra,'',9);
									$this->SetXY($x5, $y5+1);
									$this->Cell(75,4,utf8_decode("    Transporte Ferroviario - Contenedores"),0,0,'L');
									$this->SetTextColor(0,0,0);
	    ...
	    function _pageTotal($x, $y){
			...
			if($this->datoscomprobante["tipoDeComprobante"] == "T"){
				$factura_subtotal = 0;
				$factura_iva      = 0;
				$factura_total    = 0;
			}
		    ...
		    #Estilo de recuadros
			$this->SetDrawColor($this->color_div_totales["color1"], $this->color_div_totales["color2"], $this->color_div_totales["color3"]);
			$this->SetFillColor($this->color_div_totales["color1"], $this->color_div_totales["color2"], $this->color_div_totales["color3"]);
		    ...
		    $this->SetFont($this->tipo_letra,'',9);
			$this->Cell(23,7, price($factura_subtotal, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			...
			$this->SetFont($this->tipo_letra,'',9);
			$this->Cell(15,7,"I.V.A.",0,0,'L');
			$this->SetFont($this->tipo_letra,'',9);
			$this->Cell(23,7, price($factura_iva, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			...
			if ($object->remise > 0) {
				...
				$this->SetFont($this->tipo_letra,'',9);
				$this->Cell(23,7, price($object->remise, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			}
			...
			if ($db->num_rows($resql) > 0) {
				...
				#Dibujo de recuadro
				$this->RoundedRect($posXrecuadro+128,$this->GetY()+8,62,5,2,'DF','1234');
				...
				#Porcentaje Ret IVA
				$sql = "SELECT * FROM ".MAIN_DB_PREFIX."cfdimx_retencionesdet WHERE factura_id = ".$id." AND impuesto = '002' LIMIT 1";
				$res_sql = $db->query($sql);

				$porcentaje = 0;
				if($db->num_rows($res_sql) > 0){
					while ($obj = $db->fetch_object($res_sql)) {
						$porcentaje = $obj->tasa;
					}
				}

				$this->SetXY($x+130, $this->GetY()+7);
				$this->SetFont($this->tipo_letra,'',9);
				$this->Cell(15,7,"Ret. I.V.A. ".$porcentaje." %",0,0,'L');
				$this->SetFont($this->tipo_letra,'',9);
				$this->SetXY($this->GetX() + 20, $this->GetY());
				$this->Cell(23,7, price($suma_ret_iva, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			}
			#Retenciones IVA (Fin)
			...
			if ($db->num_rows($resql) > 0) {
				...
				#Porcentaje Ret ISR
				$sql = "SELECT * FROM ".MAIN_DB_PREFIX."cfdimx_retencionesdet WHERE factura_id = ".$id." AND impuesto = '001' LIMIT 1";
				$res_sql = $db->query($sql);
				...
				$this->SetXY($x+130, $this->GetY()+7);
				$this->SetFont($this->tipo_letra,'',9);
				$this->Cell(15,7,"Ret. I.S.R. ".$porcentaje." %",0,0,'L');
				$this->SetFont($this->tipo_letra,'',9);
				$this->SetXY($this->GetX() + 20, $this->GetY());
				$this->Cell(23,7, price($suma_ret_isr, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			}
			#Retenciones ISR (Fin)
			...
			if ($db->num_rows($resql_loc) > 0){
				...
				while ($obm = $db->fetch_object($resql_loc)){
					...
					$this->SetXY($x+130, $this->GetY()+7);
					$this->SetFont($this->tipo_letra,'',9);
					$this->Cell(15,7,"Ret. ".$obm->tasa." %",0,0,'L');
					$this->SetFont($this->tipo_letra,'',9);
					$this->SetXY($this->GetX() + 20, $this->GetY());
					$this->Cell(23,7, price($obm->importe, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
				}
			}
			...
			for($i=0 ; $i < sizeof($object->lines); $i++) {
				...
				if ($object->lines[$i]->fk_product != "") {
					...
					$porcentaje_ish = $producto->array_options["options_prodcfish"];

					if($object->lines[$i]->array_options["options_prodcfish"] != "" && $object->lines[$i]->array_options["options_prodcfish"] > 0){
						$porcentaje_ish = $object->lines[$i]->array_options["options_prodcfish"];
					}
				}else{
					$porcentaje_ish = $object->lines[$i]->array_options["options_prodcfish"];
				}
				...
				if($conf->global->MAIN_MODULE_MULTICURRENCY) {
					$importe_ish = $object->lines[$i]->multicurrency_total_ht;
				}else{
					$importe_ish = $object->lines[$i]->total_ht;
				}

				$ish_concepto = (($porcentaje_ish / 100) * $importe_ish);
				$totalish += $ish_concepto;
			}
			// $totalish = $ish_total;
		 ...
		 //        }
			...
			if($totalish > 0){
				...
				$this->SetFont($this->tipo_letra,'',9);
				$this->Cell(23,7, price($totalish, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
			}
			#Bloque ISH (Fin)
			...
			$this->SetFont($this->tipo_letra,'',9);
			$this->Cell(23,7, price($factura_total, 0, '', 1, -1, -1, $this->datoscomprobante['moneda']),0,0,'R');
		}
		...
		function _pageNum2Letra($x, $y){
			...
			if($aray_tipoDivisa[1] == 'USA'){
				if(strlen(floor($object->multicurrency_total_ht)) > 1){
					$tipoDivisa = mb_strtoupper("Dolares ".$aray_tipoDivisa[1]);
				}else{
					$tipoDivisa = mb_strtoupper("Dolares ".$aray_tipoDivisa[1]);
				}
			}else{
				if(strlen(floor($object->total_ttc)) > 1){
					$tipoDivisa = mb_strtoupper($aray_tipoDivisa[0]." ".$aray_tipoDivisa[1]);
				}else{
					$tipoDivisa = mb_strtoupper($aray_tipoDivisa[0]." ".$aray_tipoDivisa[1]);
				}
			}
			...
			// if($conf->global->MAIN_MODULE_MULTICURRENCY == 1 && $this->data["moneda"] != "MXN") {
			if($conf->global->MAIN_MODULE_MULTICURRENCY == 1 && $moneda != "MXN") {
				$factura_total = $object->multicurrency_total_ttc;
			}else{
				$factura_total = $object->total_ttc;
			}
			...
			$letras=utf8_encode(num2letras($factura_total,0,0).' '.$tipoDivisa);
			...
			$letras = mb_strtoupper($letras)." ".$ultimo."/100 ".($moneda == "MXN"? "MN":"ME");

			$contar_letras=strlen($letras);
			$fuente_letras = ($contar_letras>=60) ? 7 : 8;
			
			$this->SetFont($this->tipo_letra,'',$fuente_letras);
	    ...
	    function _pageQRCode(){
			...
			$data_cbb = 'https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx';
			QRcode::png($data_cbb,$conf->facture->dir_output."/".$object->ref."/".'previo_'.$object->ref.".png");
			...
			$this->Image($conf->facture->dir_output."/".$object->ref."/prev_".$object->ref.".png",162, $this->GetY()+9,42);
			...
			$this->SetFont($this->tipo_letra,'',6);
			$this->SetXY($nueva_cc_x, $this->GetY()+13);
			$this->SetTextColor($this->color_valores["color1"], $this->color_valores["color2"], $this->color_valores["color3"]);
			...
			//Dibujar recuadro
			$this->SetDrawColor($this->color_div_datosfiscales_sellos["color1"],$this->color_div_datosfiscales_sellos["color2"],$this->color_div_datosfiscales_sellos["color3"]);
			$this->SetFillColor($this->color_div_datosfiscales_sellos["color1"],$this->color_div_datosfiscales_sellos["color2"],$this->color_div_datosfiscales_sellos["color3"]);
	...
	$tipo_letra = 'DejaVu';
	$pdf->AddFont($tipo_letra,'','DejaVuSansCondensed.ttf',true);
	$pdf->SetFont($tipo_letra,'',14);
	$pdf->tipo_letra = $tipo_letra;
	...
	// $pdf->SetDrawColor($pdf->color_div_conceptos["color1"],$pdf->color_div_conceptos["color2"],$pdf->color_div_conceptos["color3"]);
	// $pdf->SetFillColor($pdf->color_div_conceptos["color1"],$pdf->color_div_conceptos["color2"],$pdf->color_div_conceptos["color3"]);
	// $pdf->RoundedRect($pdf->GetX(),$pdf->GetY()+1,190,5,3,'DF','1234');

	// //Cabeceras de tabla de partidas
	// $pdf->SetTextColor($pdf->color_div_conceptos["color4"],$pdf->color_div_conceptos["color5"],$pdf->color_div_conceptos["color6"]);
	...
	// $pdf->datoscomprobante['moneda'] = "EUR";
	...
	// 	// 					$cantidad,
	// 	// 					$unidad,
	// 	// 					trim($descripcion_pdf),
	// 	// 					price($precio_unitario, 0, '', 1, -1, -1, $pdf->datoscomprobante['moneda']),
	// 	// 					price($iva, 0, '', 1, -1, -1, $pdf->datoscomprobante['moneda']),
	// 	// 					price($total_des, 0, '', 1, -1, -1, $pdf->datoscomprobante['moneda']),
	// 	// 					price($total_partida, 0, '', 1, -1, -1, $pdf->datoscomprobante['moneda'])
	// 	// 				)
	// 	// 		);
	// }
	...
	$fichero = 'previo_'.$object->ref.'.pdf';
	$pdf->Output($conf->facture->dir_output."/".$object->ref."/".$fichero, 'F');

	if ($route == "genera")  {
		header('Location: facture.php?facid='.$id.'&cfdi_commit=1');
	}
	else {
