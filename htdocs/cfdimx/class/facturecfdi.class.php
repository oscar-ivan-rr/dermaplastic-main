...
class FactureCfdi extends CommonInvoice
{
	...
	function create($user,$notrigger=0,$forceduedate=0)
	{
		...
		if ($resql)
		{
			...
			$sql = 'UPDATE '.MAIN_DB_PREFIX."facture SET ref='".$this->ref."' WHERE rowid=".$this->id;
	...
	function fetch($rowid, $ref='', $ref_ext='', $ref_int='')
	{
		...
		$sql = 'SELECT f.rowid,f.ref,f.ref_client,f.ref_ext,f.ref_int,f.type,f.fk_soc,f.amount,f.tva, f.localtax1, f.localtax2, f.total, f.total_ttc, f.revenuestamp';
	...
	function liste_array($shortlist=0, $draft=0, $excluser='', $socid=0, $limit=0, $offset=0, $sortfield='f.datef,f.rowid', $sortorder='DESC')
	{
		...
		$sql.= " f.rowid as fid, f. as ref, f.datef as df";
	...
	function list_replacable_invoices($socid=0)
	{
		...
		$sql = "SELECT f.rowid as rowid, f., f.fk_statut,";
	...
	function list_qualified_avoir_invoices($socid=0)
	{
		...
		$sql = "SELECT f.rowid as rowid, f., f.fk_statut, f.type, f.paye, pf.fk_paiement";
		$sql.= " FROM ".MAIN_DB_PREFIX."facture as f";
		$sql.= " LEFT JOIN ".MAIN_DB_PREFIX."paiement_facture as pf ON f.rowid = pf.fk_facture";
