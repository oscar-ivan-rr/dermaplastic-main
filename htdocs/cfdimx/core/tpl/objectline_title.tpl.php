...
if($this->element == 'facture' && $this->statut == 0) {
    print '<input type="checkbox" id="all_lines" name="all_lines">';
}
print '</td>';
...
// Arrow to colaps Extra-toggle
// if(strcmp($this->element, "facture") == 0) {	
// 	print '<td class=""></td>';
// }
print '<td class=""></td>';
...
//Precio de compra
print '<td class="linecolht right" style="width:20px;">'.$langs->trans('Precio de compra').'</td>';
