...
echo '<h3 align="center">FACTURAS ACTIVAS</h3>';
...
print '<table class="noborder" width="100%">';
	...
	WHERE cancelado = 0 AND entity_id = ".$_SESSION['dol_entity']." ".$extra_qry."
	...
	if ($resql){
		 ...
		 if ($num){
			 while ($i < $num){
				...
				$var=!$var;
				print '<tr '.$bc[$var].'>';
					print "<td>&nbsp;<a href='../../cfdimx/facture.php?facid=".$obj->fk_facture."'>".$obj->factura_seriefolio."</a></td>";
