...
class CashControl extends CommonObject
{
	...
	'fk_user_creat' =>array('type'=>'integer', 'label'=>'UserCreation', 'enabled'=>1, 'visible'=>1, 'notnull'=>1, 'position'=>21),
	...
	'debitcard' =>array('type'=>'price', 'label'=>'Tarjeta de débito', 'enabled'=>1, 'visible'=>1, 'position'=>33),
	'creditcard' =>array('type'=>'price', 'label'=>'CreditCard', 'enabled'=>1, 'visible'=>1, 'position'=>36),
	'transfer' =>array('type'=>'price', 'label'=>'Transferencia', 'enabled'=>1, 'visible'=>1, 'position'=>39),
	...
	'intotal' =>array('type'=>'price', 'label'=>'Entradas', 'enabled'=>1, 'visible'=>1, 'position'=>1001),
	'outtotal' =>array('type'=>'price', 'label'=>'Salidas', 'enabled'=>1, 'visible'=>1, 'position'=>1002),
	);
	...
	public function create(User $user, $notrigger = 0)
	{
		...
		if (empty($this->debitcard)) $this->debitcard=0;
		if (empty($this->creditcard)) $this->creditcard=0;
		if (empty($this->transfer)) $this->transfer=0;
		...
		$sql .= ", ".($this->fk_user_creat? $this->fk_user_creat : "null");
	...
	public function valid(User $user, $notrigger = 0)
	{
		...
		$sql.= " intotal = '".$this->intotal."',";
		$sql.= " outtotal = '".$this->outtotal."'";
