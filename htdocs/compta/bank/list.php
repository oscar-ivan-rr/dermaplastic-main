...
if(!$user->rights->stock->show_all_warehouses) $sql.= " AND b.fk_warehouse = ".$user->fk_warehouse."";
...
if (!empty($arrayfields['b.ref']['checked']))
{
    ...
    print '<input class="flat" type="text" name="search_ref" value="'.$search_ref.'">';
    print '</td>';
}
// Label
...
{
    print '<td class="liste_titre">';
    print '<input class="flat" type="text" name="search_label" value="'.$search_label.'">';
    print '</td>';
}
// Account type
...
{
    print '<td class="liste_titre">';
    print '<input class="flat" type="text" name="search_number" value="'.$search_number.'">';
    print '</td>';
}
// Account number
