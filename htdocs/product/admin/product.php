...
if ($action == 'other')
{
	...
	$value = GETPOST('CEDIS_WAREHOUSE', 'int');
	$res = dolibarr_set_const($db, "CEDIS_WAREHOUSE", $value, 'chaine', 0, '', $conf->entity);
...
print "<tr class='oddeven'><td>Almacén definido como CEDIS</td>";
print '<td width="60" class="right">';
print $formproduct->selectWarehouses($conf->global->{'CEDIS_WAREHOUSE'}, 'CEDIS_WAREHOUSE', '', 1, 0);
print "</td></tr>\n";
