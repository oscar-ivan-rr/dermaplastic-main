...
class FormProduct
{
     ...
     *  @throws Exception
	 */
	public function selectWarehouses($selected = '', $htmlname = 'idwarehouse', $filterstatus = '', $empty = 0, $disabled = 0, $fk_product = 0, $empty_label = '', $showstock = 0, $forcecombo = 0, $events = array(), $morecss = 'minwidth200', $exclude = '', $showfullpath = 1, $stockMin = false, $orderBy = 'e.ref', $userWarehouse = false)
	{
	...
	public function selectBatch($selected = '', $htmlname = 'idbatch', $fk_product = 0, $empty_label = '', $showstock = 0, $events = array(), $morecss = 'minwidth200', $orderBy = 'rowid'){
	...
	public function selectMeasuringUnits($name = 'measuring_units', $measuring_style = '', $default = '0', $adddefault = 0, $mode = 0)
	{
		...
		if ($result < 0) {
			...
			if ($adddefault || $adddefault === '' || $adddefault == 0)
			{
