...
if ($id > 0 || ! empty($ref))
{
	...
	if ($result > 0)
	{
        ...
        elseif ($user->rights->facture->lire)
        {
            ...
            if(!empty($search_ref))
				$sql .= ' AND f.ticketnumber like "%'.$search_ref.'%"';
            ...
            if ($result)
			{
                ...
                print '<form method="post" action="posExcel.php">';
                ...
                print_barre_liste("Ventas POS", $page, $_SERVER["PHP_SELF"], "&amp;id=".$product->id, $sortfield, $sortorder, '', $num, $totalofrecords, '', 0, '', '', $limit);
                ...
                print_liste_field_titre("Cliente", $_SERVER["PHP_SELF"], "s.nom", "", $option, '', $sortfield, $sortorder);
                print_liste_field_titre("Fecha de Creación", $_SERVER["PHP_SELF"], "f.date_ticket", "", $option, 'align="center"', $sortfield, $sortorder);
                ...
                print_liste_field_titre("Status", $_SERVER["PHP_SELF"], "f.fk_statut", "", $option, 'align="right"', $sortfield, $sortorder);
                print "</tr>\n";
                ...
                if ($num > 0)
				{
                    while ($i < min($num, $limit))
					{
                        ...
                        print '<td align="right">'.$invoicestatic->LibStatut($objp->statut, 1).'</td>';
                        print "</tr>\n";
                        $i++;
                    }
                }
