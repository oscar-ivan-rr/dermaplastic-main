...
if ($id > 0 || !empty($ref)) {
	...
	if ($result > 0)
	{
		...
		if ($user->rights->fournisseur->commande->lire)
		{
			...
			$sql .= " c.date_commande, c.fk_statut as statut, c.rowid as commandeid, d.rowid, d.qty, (d.total_ht/d.qty) as pu";
			...
			if ($result) {
				...
				if ($num > 0)
				{
					while ($i < min($num, $limit))
					{
						...
						print dol_print_date($db->jdate($objp->date_commande), 'day')."</td>";
