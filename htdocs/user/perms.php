...
if ($result)
{
	...
	while ($i < $num)
	{
		...
		if (isset($obj->module) && ($oldmod <> $obj->module))
		{
			...
			if($objMod->getName() == "Vendedores"){
				print img_object('', $picto, 'class="pictoobjectwidth"').' Proveedores';
			}else{
		...
		if($objMod->getName() == "Vendedores"){
			print '<td class="maxwidthonsmartphone tdoverflowonsmartphone">'.img_object('', $picto, 'class="pictoobjectwidth"').' Proveedores</td>';
		}else{
