...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createFilterHTMLForMultiSelect = function (){
        return '<input id="' + this.comboTreeId + 'MultiFilter" type="hidden" class="multiplesFilter" placeholder="Type to filter"/>';
    }
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" data-selectable="' + isSelectable + '" class="comboTreeItemTitle ' + selectableClass+' '+sourceItem.class + '">' + (!selectableLastNode && isSelectable ? '<input type="checkbox" />' : '') + sourceItem.title + '</span>';
        else
