...
$samePrice = GETPOST('samePrice', 'int');
...
// Same price for all productos
if ($type == Categorie::TYPE_PRODUCT) {
	print '<tr><td>';
	print $langs->trans("CatSamePrice").'</td><td>';
	print $form->selectarray('samePrice', array(0 => $langs->trans('No'), 1 => $langs->trans('Yes')), $object->samePrice);
	print '</td></tr>';
}
