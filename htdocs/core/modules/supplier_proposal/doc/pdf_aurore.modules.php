...
class pdf_aurore extends ModelePDFSupplierProposal
{
	...
	*/
			...
			if (file_exists($dir))
			{
				...
				for ($i = 0 ; $i < $nblines ; $i++)
				{
					...
					if ($pageposafter > $pageposbefore)	// There is a pagebreak
					{
						...
						pdf_writelinedesc($pdf, $object, $i, $outputlangs, 68, 3, $curX, $curY, $hideref, $hidedesc,0,1);
						*/
                    ...
                    $pdf->SetXY($this->posxupc-2, $curY);
                    $pdf->MultiCell($this->postotalht - $this->posxupc +3, 3, '$'.$pu, 0, 'R', 0);
	...
	protected function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop = 0, $hidebottom = 0, $currency = '')
	{
		...
		if (empty($hidetop))
		{
			$pdf->SetXY($this->postotalht-5, $tab_top+1);
			$pdf->MultiCell(30, 2, $outputlangs->transnoentities("Importe"), '', 'R');
		}
	}
    ...
    protected function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext = 0)
	{
		...
		return pdf_pagefoot($pdf, $outputlangs, 'SUPPLIER_PROPOSAL_FREE_TEXT', '', $this->marge_basse, $this->marge_gauche, $this->page_hauteur, $object, $showdetails, $hidefreetext);
	}
}
