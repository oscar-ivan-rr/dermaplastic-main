...
class modProduct extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights[$r][0] = 1000401;
		$this->rights[$r][1] = 'Elimiinar precios de venta';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'delete_price_sale';
        $r++;

		$this->rights[$r][0] = 1000402;
		$this->rights[$r][1] = 'Elimiinar precios de compra';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'delete_price_buy';
        $r++;
