...
class modPropale extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$r++;
		$this->rights[$r][0] = 1200040; // id de la permission
		$this->rights[$r][1] = 'Crear Cotización a Proveedor desde Cotización a Cliente'; // libelle de la permission
		$this->rights[$r][2] = 'd'; // type de la permission (deprecie a ce jour)
		$this->rights[$r][3] = 0; // La permission est-elle une permission par defaut
		$this->rights[$r][4] = 'client_to_fourn';
