...
class modSociete extends DolibarrModules
{
	...
	public function __construct($db)
	{
        ...
        */
		...
		$this->rights[$r][1] = 'Editar Código de Cliente';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'edit_customer_code';

        $r++;
		$this->rights[$r][0] = 100011;
		$this->rights[$r][1] = 'Editar Código de Proveedor';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'edit_provider_code';
        ...
        */
		...
		$this->tabs = array('thirdparty:+credit_docs:Documentos de Crédito:@societe:1:/societe/credit_documents.php?id=__ID__');
	}
