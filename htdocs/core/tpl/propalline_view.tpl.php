...
<?php } ?>
<?php if (!empty($user->rights->propal->client_to_fourn) && $this->statut == 0) { //Descuento?>
	<td><input type="checkbox" class="product_discount ptp_checkbox" name="line_<?=$line->id?>" value="<?=$line->id?>"></td>
<?php } ?>
	<td><?php $coldisplay++; ?><div id="line_<?php print $line->id; ?>"></div>
<?php
...
print '</td>';
$coldisplay++;
print '<td class="nowrap linecoldescription minwidth300imp">'.$label.'</td>';
?>
