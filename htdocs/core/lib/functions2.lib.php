 ...
 *
 *	@param	float			$reduction		Reduction percentage
 *	@param	float			$pu     		Product subprice
 *	@param	float			$qty    		Line quantity
 *	@param	Translate   	$langs			Output language
 *	@return	string			    			Price reduction amount
 */
function dol_print_reduction_amount($reduction, $pu, $qty, $langs)
{
    $string = '';
    if ($reduction == 100)
    {
    ...
    {
    	$string = price((($reduction / 100) * $pu) * $qty);
    }
