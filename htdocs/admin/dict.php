...
$taborder = array(47, 0, 46, 0, 45, 0, 44, 0, 43, 0, 41, 0, 42, 0, 9, 0, 4, 3, 2, 0, 1, 8, 19, 16, 27, 38, 0, 5, 11, 0, 32, 33, 34, 0, 6, 0, 29, 0, 7, 24, 28, 17, 35, 36, 0, 10, 23, 12, 13, 0, 14, 0, 22, 20, 18, 21, 0, 15, 30, 0, 37, 0, 25, 0, 40, 0);
...
$tabname[39] = "abreviaciones_unidades";
$tabname[40] = MAIN_DB_PREFIX."c_product_rotation";
$tabname[41] = MAIN_DB_PREFIX."c_tipo_empaque";
$tabname[42] = MAIN_DB_PREFIX."c_familias_productos";
$tabname[43] = MAIN_DB_PREFIX."c_rfc";
$tabname[44] = MAIN_DB_PREFIX."c_movements_add";
$tabname[45] = MAIN_DB_PREFIX."c_movements_delete";
$tabname[46] = MAIN_DB_PREFIX."c_batch_transfer";
$tabname[47] = MAIN_DB_PREFIX."c_product_type";
...
$tablib[39] = "DictionaryAbrevUnits";
$tablib[40] = "DictionaryProductRotation";
$tablib[41] = "DictionaryPackageType";
$tablib[42] = "DictionaryProductFamily";
$tablib[43] = "DictionaryRfc";
$tablib[44] = "DictionaryAddMovement";
$tablib[45] = "DictionaryDeleteMovement";
$tablib[46] = "DictionaryBatchTransfer";
$tablib[47] = "DictionaryProductType";
...
$tabsql[18] = "SELECT rowid   as rowid, code, libelle, performance, price_gasoline, depreciation, tracking, active FROM ".MAIN_DB_PREFIX."c_shipment_mode";
...
$tabsql[39] = "SELECT r.rowid, r.code,JSON_EXTRACT(r.labels, '$.labels') as labels, r.short_label,r.active FROM abreviaciones_unidades r";
$tabsql[40] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_product_rotation";
$tabsql[41] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_tipo_empaque";
$tabsql[42] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_familias_productos";
$tabsql[43] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_rfc";
$tabsql[44] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_movements_add";
$tabsql[45] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_movements_delete";
$tabsql[46] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_batch_transfer";
$tabsql[47] = "SELECT rowid, code, label, active FROM ".MAIN_DB_PREFIX."c_product_type";
...
$tabsqlsort[39] = "r.rowid,r.code, r.short_label ASC";
$tabsqlsort[40] = "rowid, code ASC";
$tabsqlsort[41] = "label ASC";
...
$tabfield[18] = "code,libelle,performance,price_gasoline,depreciation";
...
$tabfield[39] = "code,labels,short_label";
$tabfield[40] = "code,label";
$tabfield[41] = "code,label";
$tabfield[42] = "code,label";
$tabfield[43] = "code,label";
$tabfield[44] = "code,label";
$tabfield[45] = "code,label";
$tabfield[46] = "code,label";
$tabfield[47] = "code,label";
...
$tabfieldvalue[18] = "code,libelle,performance,price_gasoline,depreciation";
...
$tabfieldvalue[39] = "code,labels,short_label";
$tabfieldvalue[40] = "code,label";
$tabfieldvalue[41] = "code,label";
$tabfieldvalue[42] = "code,label";
$tabfieldvalue[43] = "code,label";
$tabfieldvalue[44] = "code,label";
$tabfieldvalue[45] = "code,label";
$tabfieldvalue[46] = "code,label";
$tabfieldvalue[47] = "code,label";
...
$tabfieldinsert[18] = "code,libelle,performance,price_gasoline,depreciation";
...
$tabfieldinsert[39] = "code,labels,short_label";
$tabfieldinsert[40] = "code,label";
$tabfieldinsert[41] = "code,label";
$tabfieldinsert[42] = "code,label";
$tabfieldinsert[43] = "code,label";
$tabfieldinsert[44] = "code,label";
$tabfieldinsert[45] = "code,label";
$tabfieldinsert[46] = "code,label";
$tabfieldinsert[47] = "code,label";
...
$tabcond[39] = !empty($conf->product->enabled);
$tabcond[40] = !empty($conf->product->enabled);
$tabcond[41] = true;
$tabcond[42] = true;
$tabcond[43] = true;
$tabcond[44] = true;
...
$tabhelp[40] = array('code'=>$langs->trans("EnterAnyCode"));
$tabhelp[41] = array();
$tabhelp[42] = array();
$tabhelp[43] = array();
$tabhelp[44] = array();
...
if (GETPOST('actionadd') || GETPOST('actionmodify'))
{
    ...
    foreach ($listfield as $f => $value)
    {
		...
		if ((!isset($_POST[$value]) || $_POST[$value] == '')
			...
			if ($fieldnamekey == 'performance') $fieldnamekey = 'Performance';
			if ($fieldnamekey == 'price_gasoline') $fieldnamekey = 'Price_gasoline';
			if ($fieldnamekey == 'depreciation') $fieldnamekey = 'Depreciation';
    ...
    if ($id == 18 && !empty($_POST["performance"]) && !is_numeric($_POST["performance"])) {
        $ok = 0;
        setEventMessages($langs->transnoentities("ErrorFieldMustBeANumeric", $langs->transnoentities("Performance")), null, 'errors');
    }
    if ($id == 18 && !empty($_POST['price_gasoline']) && !is_numeric($_POST['price_gasoline'])) {
        $ok = 0;
        setEventMessages($langs->transnoentities("ErrorFieldMustBeANumeric", $langs->transnoentities("Gasoline")), null, 'errors');
    }
    if ($id == 18 && !empty($_POST['depreciation']) && !is_numeric($_POST['depreciation'])) {
        $ok = 0;
        setEventMessages($langs->transnoentities("ErrorFieldMustBeANumeric", $langs->transnoentities("Depreciation")), null, 'errors');
    }
    ...
    if ($ok && GETPOST('actionadd'))
    {
        ...
        foreach ($listfieldinsert as $f => $value)
        {
            ...
            elseif ($keycode == 'labels'){
                $labels = explode(',',$_POST[$keycode]);
                $labels = json_encode(array("labels"=>$labels));
                $sql .= "'".$db->escape($labels)."'";
            }
            else {
...
if ($id)
{
    ...
    if ($tabname[$id])
    {
        ...
        foreach ($fieldlist as $field => $value)
        {
			...
			if ($fieldlist[$field] == 'performance') { $valuetoshow = $langs->trans('Performance'); }
			if ($fieldlist[$field] == 'use_default') { $valuetoshow = $langs->trans('Default'); }
			if ($fieldlist[$field] == 'labels') { $valuetoshow = $langs->trans('Abreviaciones'); }
        ...
        if ($num)
        {
            ...
            while ($i < $num)
            {
                ...
                if ($action == 'edit' && ($rowid == (!empty($obj->rowid) ? $obj->rowid : $obj->code)))
                {
                    ...
                    $error = $hookmanager->error; $errors = $hookmanager->errors;
                    if($tabname[$id] == 'abreviaciones_unidades')
                    {
                        $labels = json_decode($obj->labels);
                        $show = '';
                        $size = sizeof($labels);
                        $iterador = 0;
