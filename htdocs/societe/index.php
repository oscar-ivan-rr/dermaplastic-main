...
$transAreaType = $langs->trans("Clientes | Proveedores");
$helpurl = 'EN:Module_Third_Parties|FR:Module_Tiers|ES:M&oacute;dulo_Terceros';

llxHeader("", $langs->trans("Clientes | Proveedores"), $helpurl);
$linkback = '';
...
print '</div>';
*/
require_once('./index_graph1.php');
require_once('./index_graph2.php');
require_once('./index_graph3.php');
