...
class Cronjob extends CommonObject
{
	...
	/**
	 * @var int Limit between day to now to show job in list
	 */
	public $datelimit;
    ...
    public function create($user, $notrigger = 0)
    {
		...
		$sql .= " ".(empty($this->datelimit) ? '0' : $this->db->escape($this->datelimit)) ."";
		$sql .= ")";
    ...
    public function update($user = null, $notrigger = 0)
    {
		...
		$sql .= " datelimit=".((isset($this->datelimit) && $this->datelimit > 0) ? $this->datelimit : "0")."";
