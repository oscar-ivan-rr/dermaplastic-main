...
if ($action=='add')
{
	...
	$object->datelimit=GETPOST('datelimit', 'int');
...
if (($action=="create") || ($action=="edit"))
{
	...
	print '<tr><td  class="fieldrequired titlefieldcreate" >Sección Especial</td><td><hr></td><</tr>';

	// Selector de fecha para definir el limite al cual se hará la consulta de los registros a procesar
	print '<tr><td>';
	print "Fecha Límite</td>";
	print "<td><input type=\"number\" size=\"2\" name=\"datelimit\" value=\"".$object->datelimit."\" /> ";
	print "</td>";
	print "<td>";
	print "</td>";
	print "</tr>";
...
else
{
	...
	print 'Fecha limite';
	print "</td><td>";
	// creamos un calendar para seleccionar la fecha limite
	print $object->datelimit;
	print "</td>";
	print "</tr>";
