...
class modPos extends DolibarrModules
{
	...
	function modPos($DB)
	{
		...
		*/
		...
		$this->rights[$r][1] = 'Cancelar Tickets con Pagos y/o Movimientos de Stock';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'cancelpaidticket';

		$this->rights[$r][0] = 4000099;
		$this->rights[$r][1] = 'Ver ticket sin cerrar';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'viewunclosedticket';

		$this->rights[$r][0] = 4000100;
		$this->rights[$r][1] = 'Quitar factura de ticket';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'unlinkinvoice';

		$this->rights[$r][0] = 4000101;
		$this->rights[$r][1] = 'Facturar ticket más de una vez';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'invoicemorethanonce';
		...
		// Example to declare the Top Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>0,			// Put 0 if this is a top menu
									...
									'perms'=>'$user->rights->pos->backend || $user->rights->pos->frontend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
									'target'=>'',
