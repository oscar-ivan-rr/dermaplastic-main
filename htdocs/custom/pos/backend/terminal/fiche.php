...
if ($_POST["action"] == 'add')
{
	...
	$cash->fk_paybank_extra_2 		= GETPOST('bank_extra_2');
	$cash->fk_modepaybank_extra_2 	= GETPOST('modebank_extra_2');
	$cash->fk_paybank_extra_3 		= GETPOST('bank_extra_3');
	$cash->fk_modepaybank_extra_3 	= GETPOST('modebank_extra_3');
...
if ($action == 'create')
{
	...
	// Bank_extra 2
	print '<tr><td valign="top" >'.$langs->trans("PaymentBankExtra").' 2</td>';
	print '<td colspan="3">';
	print $form->select_comptes(isset($_POST["bank_extra_2"])?$_POST["bank_extra_2"]:1,'bank_extra_2',0, $filtrebank);
	print '</td></tr>';

	// Mode payment Bank
	print '<tr><td valign="top" >'.$langs->trans("ModePaymentBankExtra").' 2</td>';
	print '<td colspan="3">';
	print $form->select_types_paiements(isset($_POST["modebank_extra_2"])?$_POST["modebank_extra_2"]:0,'modebank_extra_2','', 0);
	print '</td></tr>';

	// Bank_extra 3 --- tickets de regalo
	print '<tr><td valign="top" >'.$langs->trans("Ticket de Regalo").'</td>';
	print '<td colspan="3">';
	print $form->select_comptes(isset($_POST["bank_extra_3"])?$_POST["bank_extra_3"]:1,'bank_extra_3',0, $filtrebank);
	print '</td></tr>';

	// Mode payment Bank
	print '<tr><td valign="top" >Cuenta de Ticket de Regalo</td>';
	print '<td colspan="3">';
	print $form->select_types_paiements(isset($_POST["modebank_extra_3"])?$_POST["modebank_extra_3"]:0,'modebank_extra_3','', 0);
	print '</td></tr>';
...
else
{
		...
		*/
		...
		if ($conf->banque->enabled)
		{
			if ($cash->fk_paycash)
			{
				...
				$bankline_extra_2=new Account($db);
				$bankline_extra_2->fetch($cash->fk_paybank_extra_2);


				print '<tr>';
				print '<td>'.$langs->trans('PaymentBankExtra').' 2</td>';
				print '<td colspan="3">';
				print $bankline_extra_2->getNomUrl(1);
				print '</td>';
				print '</tr>';

				// Payment mode
				print '<tr>';
				print '<td>'.$langs->trans('ModePaymentBankExtra').' 2</td>';
				print '<td colspan="3">';
				$form->form_modes_reglement($_SERVER['PHP_SELF'].'?id='.$cash->id,$cash->fk_modepaybank_extra_2,'none');
				print "</td>";
				print '</tr>';

				$bankline_extra_3=new Account($db);
				$bankline_extra_3->fetch($cash->fk_paybank_extra_3);

				print '<tr>';
				print '<td>Cuenta Ticket de Regalo</td>';
				print '<td colspan="3">';
				print $bankline_extra_3->getNomUrl(1);
				print '</td>';
				print '</tr>';
				// Payment mode
				print '<tr>';
				print '<td>Forma de pago Ticket de Regalo</td>';
				print '<td colspan="3">';
				$form->form_modes_reglement($_SERVER['PHP_SELF'].'?id='.$cash->id,$cash->fk_modepaybank_extra_3,'none');
				print "</td>";
				print '</tr>';
    ...
    if (GETPOST("id") && $action == 'edit' && $user->rights->pos->backend)
    {
		...
		if ($conf->banque->enabled)
		{
			...
			print '<tr><td valign="top" >'.$langs->trans("ModePaymentBankExtra").'</td>';
			print '<td colspan="3">';
			print $form->select_types_paiements($cash->fk_modepaybank_extra?$cash->fk_modepaybank_extra:1,'modebank_extra','',0);
			print '</td></tr>';
			...
			print '<td colspan="3">';
			//print
			$form->select_comptes($cash->fk_paybank_extra_2,'bank_extra_2',0, $filtrebank);
			print '</td></tr>';

			//Mode Bank Payment Extra
			print '<tr><td valign="top" >'.$langs->trans("ModePaymentBankExtra").' 2</td>';
			print '<td colspan="3">';
			print $form->select_types_paiements($cash->fk_modepaybank_extra_2?$cash->fk_modepaybank_extra_2:1,'modebank_extra_2','',0);
			print '</td></tr>';

			// Bank Extra 2 --- Ticket de Regalo
			print '<tr><td valign="top" >Cuenta Ticket de Regalo</td>';
			print '<td colspan="3">';
			//print
			$form->select_comptes($cash->fk_paybank_extra_3,'bank_extra_3',0, $filtrebank);
			print '</td></tr>';

			//Mode Bank Payment Extra
			print '<tr><td valign="top" >Forma de pago Ticket de Regalo</td>';
			print '<td colspan="3">';
			print $form->select_types_paiements($cash->fk_modepaybank_extra_3?$cash->fk_modepaybank_extra_3:1,'modebank_extra_3','',0);
			print '</td></tr>';
