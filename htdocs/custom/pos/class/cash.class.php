...
class Cash extends CommonObject
{
    ...
    var $fk_paybank_extra_2;
    var $fk_modepaybank_extra_2;

    var $fk_paybank_extra_3;
    var $fk_modepaybank_extra_3;
    ...
    function Cash($DB, $code='')
    {
        ...
        $this->fk_modepaybank_extra_2=0;
        $this->fk_modepaybank_extra_3=0;
        $this->fk_paybank_extra=0;
        $this->fk_paybank_extra_2=0;
        $this->fk_paybank_extra_3=0;
        $this->fk_warehouse=0;
        $this->fk_soc=0;
		$this->fk_device=0;
		$this->is_used=0;
    ...
    function create($user)
    {
        ...
        $fk_paybank_extra_2 = $this->fk_paybank_extra_2;
        $fk_paybank_extra_3 = $this->fk_paybank_extra_3;
        if($this->fk_modepaybank_extra == 0)
        	$this->fk_modepaybank_extra = -1;
        if($this->fk_modepaybank_extra_2 == 0)
        	$this->fk_modepaybank_extra_2 = -1;
        if($this->fk_modepaybank_extra_3 == 0)
        	$this->fk_modepaybank_extra_3 = -1;
        ...
        $sql.= ", fk_paybank_extra_2";
        $sql.= ", fk_modepaybank_extra_2";
        $sql.= ", fk_paybank_extra_3";
        $sql.= ", fk_modepaybank_extra_3";
        $sql.= ", fk_warehouse";
        $sql.= ", fk_device";
        $sql.= ", printer_name";
        $sql.= ", fk_soc";
		...
		$sql.= ",".($this->fk_paybank_extra_2?$this->fk_paybank_extra_2:"null");
		$sql.= ",".($this->fk_modepaybank_extra_2?$this->fk_modepaybank_extra_2:"null");
		$sql.= ",".($this->fk_paybank_extra_3?$this->fk_paybank_extra_3:"null");
		$sql.= ",".($this->fk_modepaybank_extra_3?$this->fk_modepaybank_extra_3:"null");
    ...
    function fetch($rowid, $ref='')
    {
        ...
        if ($result)
        {
            if ($this->db->num_rows($result))
            {
                ...
                $this->fk_paybank_extra_2		= $obj->fk_paybank_extra_2;
                $this->fk_modepaybank_extra_2	= $obj->fk_modepaybank_extra_2;
                $this->fk_paybank_extra_3		= $obj->fk_paybank_extra_3;
                $this->fk_modepaybank_extra_3	= $obj->fk_modepaybank_extra_3;
    ...
    function update($user)
    {
        ...
        if (isset($this->fk_paybank_extra_2)) $this->fk_paybank_extra_2=trim($this->fk_paybank_extra_2);
        if (isset($this->fk_paybank_extra_3)) $this->fk_paybank_extra_3=trim($this->fk_paybank_extra_3);
        ...
        if (isset($this->fk_modepaybank_extra_2)) $this->fk_modepaybank_extra_2=trim($this->fk_modepaybank_extra_2);
        if (isset($this->fk_modepaybank_extra_3)) $this->fk_modepaybank_extra_3=trim($this->fk_modepaybank_extra_3);
        ...
        $sql.= " fk_paybank_extra_2=".(isset($this->fk_paybank_extra_2)?$this->fk_paybank_extra_2:"null").",";
        $sql.= " fk_paybank_extra_3=".(isset($this->fk_paybank_extra_3)?$this->fk_paybank_extra_3:"null").",";
        ...
        $sql.= " fk_modepaybank_extra_2=".(isset($this->fk_modepaybank_extra_2)?$this->fk_modepaybank_extra_2:"null").",";
        $sql.= " fk_modepaybank_extra_3=".(isset($this->fk_modepaybank_extra_3)?$this->fk_modepaybank_extra_3:"null").",";
...
class ControlCash extends CommonObject
{
    ...
    function Create($data)
    {
        ...
        if ($resql)
        {
        	...
        	if ($data['type_control']==1)
        	{
        		...
        		$terminal = new Cash($this->db);
        		$terminal->fetch($_SESSION['TERMINAL_ID']);
        		$this->fk_warehouse = $terminal->fk_warehouse;
	...
	function setTicketClosedbyCash($closeid,$date_close)
	{
		...
		//$sql.=" set fk_statut= 2,";
		$sql.=" set fk_control=".$closeid;
		$sql.=" where date_closed>'".$date_close."'";
		//$sql.=" and fk_cash=".$this->terminal;
		$sql.=" and fk_cash in (SELECT rowid from ".MAIN_DB_PREFIX."pos_cash where fk_warehouse = ".$this->fk_warehouse.")";
